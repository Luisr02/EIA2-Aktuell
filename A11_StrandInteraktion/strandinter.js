...
(function (StrandInter) {
    ...
    function drawCloud() {
        var cloud1 = new StrandInter.Cloud();
        var cloud2 = new StrandInter.Cloud();
    ...
    function drawObjects() {
        ...
        var cloud1 = new StrandInter.Cloud();
        var cloud2 = new StrandInter.Cloud();
        var seagull1 = new StrandInter.Seagull();
        var seagull2 = new StrandInter.Seagull();
        var swimmer1 = new StrandInter.Swimmers();
        var swimmer2 = new StrandInter.Swimmers();
    }
